    ...
    <div>
      ...
      <div style="border-top:2px solid var(--green-primary);padding-top:36px;margin-top:4px">
        ...
        <div style="margin-bottom:28px;border-radius:8px;overflow:hidden;border:1px solid var(--border)">
          <img src="https://www.greif.ru/wp-content/uploads/pererabotka.png" alt="Восстановление б/у еврокубов" style="width:100%;display:block;object-fit:contain">
        </div>
