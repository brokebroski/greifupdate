...
const PRODUCTS = [
  ...
  { cat: 'Конические бочки', title: 'Конические бочки', desc: 'Стальная тара для транспортировки и хранения овощных и фруктовых концентратов, а также непищевых продуктов.', vol: '218-220 л', tag: '', icon: 'conical', img: 'https://www.greif.ru/wp-content/uploads/konboch.png', page: 'conical' },
